  ...
  _createClass(Formhandler, [{
    ...
    value: function addSubmitHandler(fn) {
      ...
      this.$formElement.submit(function (event) {
        ...
        var data = {};
        (0, _jquery2.default)(":input").serializeArray().forEach(function (item) {
